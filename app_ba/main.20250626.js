...
class SelectDbComponent {
    ...
    configure() {
        ...
        localStorage.setItem('url', 'https://www.blancoamor.com');
...
class StockService {
    ...
    getWh() {
        const transaction$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"]((observer) => {
            var prlsIds = [];
            this.odooRPC
                .searchRead('stock.warehouse', [], ['name', 'lot_stock_id', 'lot_stock_id'], 0, 0)
                .then((res) => {
                observer.next(res);
                observer.complete();
                observer.complete();
...
class LoginComponent {
    ...
    ngOnInit() {
        ...
        localStorage.setItem('url', 'https://www.blancoamor.com');
        localStorage.setItem('dbName', 'prod');
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _services_odoo_rpc_service__WEBPACK_IMPORTED_MODULE_3__["OdooRPCService"] }, { type: _services_alert_service__WEBPACK_IMPORTED_MODULE_4__["AlertService"] }]; }, null); })();
...
function EntWhSelectorComponent_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("routerLink", "/stock/location-entry/", item_r1.lot_stock_id[0], "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"](" ", item_r1["name"], " (", item_r1.lot_stock_id[1], ") ");
} }
...
class OdooRPCService {
    ...
    sendRequest(url, params) {
        ...
        return this.http.post('https://www.blancoamor.com' + url, body, { headers: this.headers })
            .toPromise()
...
//# sourceMappingURL=main.dd5540dda854feb9629b.js.map
